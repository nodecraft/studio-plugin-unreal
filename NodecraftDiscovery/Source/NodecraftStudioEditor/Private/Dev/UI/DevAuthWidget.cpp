...
{
	UNodecraftStudioApi::MakeRequest(this, URI, HttpMethod, HeaderToken, RequestBody,
		CALLBACK_DEF
	   {
	   		CALLBACK_BODY_BASE
	   })->ProcessRequest();
...
void UDevAuthWidget::SendRequest()
{
	...
	{
		HeaderToken = UNodecraftStudioSessionManager::Get().GetGameAccessToken();
	}
	...
	{
		HeaderToken = UNodecraftStudioSessionManager::Get().GetPlayerAccessToken();
	}
...
{
	UNodecraftStudioApi::Ident_ManualChallenge(this, EmailAddressTextBox->GetText().ToString(),
	CALLBACK_DEF
	   {
		  CALLBACK_BODY_BASE
	   })->ProcessRequest();
...
void UDevAuthWidget::SendToken()
{
	...
	UNodecraftStudioApi::Ident_Token(this, EmailAddressTextBox->GetText().ToString(), TokenTextBox->GetText().ToString(),
	EmptyConsents,
	CALLBACK_DEF
	   {
		  CALLBACK_BODY_BASE
